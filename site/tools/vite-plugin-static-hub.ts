...
import { bigCtaMarkup, gatesMarkup, roomsMarkup, tickerMarkup } from '../src/worlds/lane-markup';
...
export function staticHub(): Plugin {
  ...
  return {
    ...
    transformIndexHtml: {
      ...
      handler(html, ctx) {
        ...
        if (file !== resolve(root, 'index.html')) return html;
